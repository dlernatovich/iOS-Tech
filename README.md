...
- генератор відповідей прямо у списку питань;
...
- увімкнути `Показувати відповіді`, щоб бачити коротку відповідь, тези, приклад коду і follow-up для інтерв'юера прямо в списку.
...
Додаткова база з PDF/DOU-списку лежить у `assets/dou-ios-questions.js`. Відповіді для генератора описані в `assets/answers.js`: вони покривають усю базу через правила за темами, а готові навчальні сторінки можна поступово додавати й лінкувати з конкретними питаннями.
